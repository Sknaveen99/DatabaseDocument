...
CREATE PROCEDURE SP_State_ dropdown_list
AS
BEGIN
SELECT *
FROM (VALUES 
  ...
  (17, 'Mizoram'), (18, 'Nagaland'), (19, 'Odisha'),
  (20, 'Punjab'), (21, 'Rajasthan'), (22, 'Sikkim'),
  (23, 'Tamil Nadu'), (24, 'Telangana'), (25, 'Tripura'),
  ...
  (33, 'Jammu and Kashmir'), (34, 'Ladakh'), (35, 'Lakshadweep'),
  (36, 'Puducherry')
